...
import sensirion_i2c_sen68

# Add project directory such that sphinx can detect the package.
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))

# -- Project information -----------------------------------------------------
distribution = pkg_resources.get_distribution('sensirion_i2c_sen68')

project = u'sensirion_i2c_sen68'
copyright = u'{} Sensirion AG, Switzerland'.format(datetime.now().year)
author = 'Sensirion AG'

# The short X.Y version
version = sensirion_i2c_sen68.__version__
# The full version, including alpha/beta/rc tags
release = sensirion_i2c_sen68.__version__
