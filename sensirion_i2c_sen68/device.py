...
from sensirion_i2c_sen68.result_types import (SignalDividedBy10Int16, SignalDividedBy10Uint16, SignalHumidity,
                                              SignalTemperature)
...
class Sen68DeviceBase:
    ...
    def read_measured_values_as_integers(self):
        ...
        :return hcho:
            Value is scaled with a factor of 10: HCHO [ppb] = value / 10
...
class Sen68Device(Sen68DeviceBase):
    ...
    def read_measured_values(self):
        ...
        return (SignalDividedBy10Uint16(mass_concentration_pm1p0_raw),
                ...
                SignalDividedBy10Int16(nox_index_raw), SignalDividedBy10Uint16(hcho_raw))
