...
class Sen68Device(Sen68DeviceBase):
    ...
    def read_measured_values(self):
        ...
        :return a_hcho:
            Measured formaldehyde concentration in ppm.
        """
        (mass_concentration_pm1p0_raw, mass_concentration_pm2p5_raw, mass_concentration_pm4p0_raw,
         mass_concentration_pm10p0_raw, temperature_raw, humidity_raw, voc_index_raw, nox_index_raw,
         hcho_raw
        ...
        return (SignalMassConcentrationPm1p0(mass_concentration_pm1p0_raw),
                ...
                SignalMassConcentrationPm10p0(mass_concentration_pm10p0_raw), SignalTemperature(temperature_raw),
                SignalHumidity(humidity_raw), SignalVocIndex(voc_index_raw), SignalNoxIndex(nox_index_raw),
                SignalHcho(hcho_raw))
