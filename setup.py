...
version_line = open("sensirion_i2c_sen68/version.py", "rt").read()
...
setup(
    name='sensirion_i2c_sen68',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='I2C driver for the Sensirion SEN68 sensor family',
    license='BSD',
    ...
    project_urls={
        ...
        "Changelog": "https://github.com/Sensirion/python-i2c-sen68/blob/master/CHANGELOG.rst",
    },
